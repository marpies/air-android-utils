...
package com.marpies.ane.androidutils.data {
    ...
    public class AndroidVersionCodes {
        ...
        /**
         * June 2014: Android 4.4W: KitKat for watches.
         */
        public static const KITKAT_WATCH:int = 20;

        /**
         * November 2014: Lollipop.
         */
        public static const LOLLIPOP:int = 21;

        /**
         * March 2015: Lollipop.
         */
        public static const LOLLIPOP_MR1:int = 22;

        /**
         * October 2015: Marshmallow.
         */
        public static const MARSHAMLLOW:int = 23;
